public class Ejercicio3 {
    public static void main(String[] args) {
         ...
         * produciendo un fenómeno llamado zona muerta. Debido a los altos niveles de
         * nitrógeno y fósforo que traen estas aguas los peces mueren en grandes
         * cantidades.
         * 
         * Para evitar que mueran cientos y cientos de peces, la ONG Salvemos los peces
         * de colores ha decidido poner en cuarentena a 284 peces rojos y 163 peces
